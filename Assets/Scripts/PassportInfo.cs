...
public class PassportInfo : MonoBehaviour {
    ...
    {
        get { return txtExpires.text; }
        set { txtExpires.text = value; }
    }
    ...
    void Awake()
    {
        ...
        if (tempObj != null) txtExpires = tempObj.GetComponent<TextMesh>();
        else Debug.Log("Passport has no txt_expires!");
